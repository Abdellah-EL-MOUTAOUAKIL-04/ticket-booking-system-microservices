...
export class EventService {
  ...
  public saveEvent(event:Event):Observable<Event>{
    return this.http.post<Event>(environment.apiUrl+"/venue",event);
  }
  public updateEvent(event:Event,eventId:number):Observable<Event>{
    return this.http.put<Event>(environment.apiUrl+"/venue/"+eventId,event);
  }
  public deleteEvent(eventId:number):Observable<any>{
    return this.http.delete(environment.apiUrl+"/venue/"+eventId);
  }
}
